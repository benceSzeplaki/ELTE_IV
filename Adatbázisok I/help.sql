...
SELECT DISTINCT SZ1.NEV AS NEV, SZ2.NEV AS NEV
FROM SZERET SZ1, SZERET SZ2
WHERE SZ1.NEV != SZ2.NEV AND SZ1.GYUMOLCS != SZ2.GYUMOLCS;

-- RELÁCIÓS ALGEBRA:

--2. feladat -MEGVAN,DE NEM JÓ
--Melyek azok a gyümölcsök, amelyeket pontosan azok szeretik, akik a 'korte'-t is szeretik (GYUMOLCS)?
